...
Drupal.behaviors.psoBlogViewFilters = {
  attach: function (context, settings) {
    // Submit the form when the category selector changes.
    $('.views-widget-filter-field_article_category', context).once('select', function () {
